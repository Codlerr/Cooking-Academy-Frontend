              ...
              <div className='xs:px-2 md:px-0 xs:pt-5 md:pt-0'>
                <form className='flex xs:flex-col md:flex-row justify-start gap-5 '>
                  <div className='flex flex-col gap-2'>
                    <input required className='outline-none  bg-black rounded-md border-2 border-[#383737] text-xl py-1 lg:w-72' type="email" />
                    <span className='flex'><input required className='ml-1 mr-3' type='checkbox'/><p className='text-xs text-[#ffffffb0]'>I agree to receive email updates</p></span>
                  </div>
