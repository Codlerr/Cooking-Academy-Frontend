...
export default function lsa(props) {
  return (
    <>
      ...
      <div data-aos="fade-right" className='md:w-10/12 mx-auto md:pt-5 grid grid-cols-2 md:grid-cols-4 xs:gap-5 md:gap-0 place-items-center text-[color:var(--thm-clr2)] py-2'>
        <div className='grid place-items-center'>
          <h4 className='xs:text-6xl lg:text-7xl'>+25</h4>
        ...
        <div className='grid place-items-center'>
          <h4 className='xs:text-6xl lg:text-7xl'>+03</h4>
          <p className='capitalize'>awards</p>
        </div>
        <div className='grid place-items-center'>
          <h4 className='xs:text-6xl lg:text-7xl'>+150</h4>
