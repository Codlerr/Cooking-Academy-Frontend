  ...
  return (
    ...
    <section className='kitchen-banner'>
        <div className='h-full w-11/12 mx-auto grid grid-cols-1 md:grid-cols-2 gap-y-5'>
            ...
            <div className='flex justify-center items-center md:mt-16 lg:mt-0'>
                <form className='md:w-[70%] lg:w-[60%] rounded-3xl bg-gradient-to-b from-slate-300 to-zinc-700 text-black'>
                    <div className='p-3 lg:p-6 flex flex-col xs:gap-4 md:gap-2 lg:gap-4'>
                        <h1 className='w-[80%] mx-auto lg:text-xl text-center font-medium'>Have some questions or want to say hi?</h1>
