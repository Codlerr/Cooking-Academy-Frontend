  ...
  return (
    <div className='h-screen w-full flex flex-col justify-center items-center'>
       <div className='w-fit grid place-items-center gap-5'>
            ...
            <button className='bg-primary-clr2 rounded-lg hover:bg-primary-clr1 transition-all duration-300 px-10 py-2'><NavLink to='/profile'>Go to Course</NavLink></button>
       </div>
    </div>
  )
}
