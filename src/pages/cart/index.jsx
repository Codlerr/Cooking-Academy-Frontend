...
let Pic = 'https://res.cloudinary.com/dvbplh4z9/image/upload/v1671270925/Cooking%20Academy%20Assets/cooking%20class/Rectangle_167_qkjplb.webp';
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-10'>
            <div className='lg:col-span-2 grid gap-10 rounded-xl overflow-hidden bg-white xs:p-5 lg:p-10'>
                ...
                <div className='grid gap-3 lg:gap-0 grid-cols-1 md:grid-cols-1 lg:grid-cols-4 text-black'>
                    <img className='lg:h-28 lg:w-44 object-cover rounded-md' src={Pic} alt="image" />
               ...
               {/* CheckOut Btn */}
                <div className='flex justify-end'>
                    <a className='bg-primary-clr2 hover:bg-primary-clr1 transition-all duration-300 rounded-md px-16 lg:px-24 py-2 lg:py-5' href="#">Checkout</a>
                </div>
            </div>
            ...
            <div className='grid gap-10 h-fit'>
                ...
                <div>
                    ...
                    <div className='block relative rounded-md overflow-hidden'>
                        <input className='w-[100%] p-3 text-black' type="text" placeholder='Enter Coupon'/>
                        <button className='bg-primary-clr2 absolute rounded-tl-md rounded-bl-md text-base right-0 top-0 py-3 px-10 hover:text-white'>Apply</button>
                    </div>
                    <p className='text-sm pt-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione ullam perspiciatis minus voluptatibus aspernatur dolores at fugiat cupiditate voluptates autem consectetur et inventore nesciunt neque nobis mollitia facilis a asperiores, iste nulla possimus perferendis alias esse cumque! Voluptates reiciendis, ipsa nihil porro ex tenetur cum amet.</p>
                </div>
