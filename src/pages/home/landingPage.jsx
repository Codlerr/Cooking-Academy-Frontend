          ...
          <div id='chefs' className='xs:hidden md:block relative grid place-items-center pt-20'>
              <div className='flex justify-center relative'>
                  ...
                  <div id='cheftip4' className='relative'>
                    <img src={Chef4} className='relative pt-20 -left-20  z-20 md:h-[500px] hover:z-30 hover:scale-105 transition-all duration-150 ease-in-out cursor-pointer' alt='img'/>
