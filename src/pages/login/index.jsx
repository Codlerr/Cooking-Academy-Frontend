    ...
    <section className='h-screen w-full grid place-items-center'>
        <div className='h-[80vh] w-full overflow-hidden grid grid-cols-1 lg:grid-cols-6 place-items-center'>
            ...
            <div className='col-span-2 xs:w-[80%] md:w-[60%] l:w-[70%] mx-auto'>
                ...
                <p className='text-primary-clr2 py-5'>New user?<a className='pl-5 text-text-dark' href="/signup">Create an account</a></p>
                <form className='flex flex-col gap-4' action="">
                    ...
                    <button type='submit' className='bg-primary-dark hover:bg-primary-clr1 py-2 transition-all duration-200 rounded-md'>Sign In</button>
                </form>
